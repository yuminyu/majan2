        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">   
                ...
                <div class="relative">
                    ...
                    <input type="number" min="0" max="10" id="seiketsusa" name="seiketsusa" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                </div>
                <div class="p-2 w-1/4">
                <div class="relative">
                    <label for="huniki" class="leading-7 text-sm text-gray-600">雰囲気</label>
                    <input type="number" min="0" max="10" id="huniki" name="huniki" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                </div>
                <div class="p-2 w-1/4">
                <div class="relative">
                    <label for="yasusa" class="leading-7 text-sm text-gray-600">ゲーム代の安さ</label>
                    <input type="number" min="0" max="10" id="yasusa" name="yasusa" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                </div>
                <div class="p-2 w-1/4">
                <div class="relative">
                    <label for="mataikitai" class="leading-7 text-sm text-gray-600">また行きたい度</label>
                    <input type="number" min="0" max="10" id="mataikitai" name="mataikitai" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                </div>
                <div class="p-2 w-full">
                <div class="relative">
